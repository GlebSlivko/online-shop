...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img class="h-100" src=${productsFG[productId].img} alt="products">
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t</div>
